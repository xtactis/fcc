...
all_tests=( 'main' 'int' 'two_variables' 'int_assign' 'int_assign_exp' 'return_exp' 'return_var' 'scope' 'ternary' 'if' 'ifelse' 'ifelseif' 'ifsabound' 'while' 'for' 'pointer' 'undeclared_variable' )
